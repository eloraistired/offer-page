...
export const DemoVideo = () => {
  return (
    <section className="pt-16 pb-6 bg-primary-background" id="demo">
      <div className="container">
        <HeadingWrapper>
          <Heading>Funnel Liner কি?</Heading>
        ...
        <div className="flex items-center justify-center pt-6">
          <div className="w-full h-[270px] md:h-[480px] max-w-4xl overflow-hidden rounded-xl">
            <iframe
              width="100%"
              height="100%"
              src="https://www.youtube-nocookie.com/embed/keEKKeQ9-Yw?si=zgPR9KOUgnj5SAtN"
